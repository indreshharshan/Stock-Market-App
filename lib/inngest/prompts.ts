...
export const PORTFOLIO_MOVEMENT_EXPLANATION_PROMPT = `Analyze the given portfolio data and explain the reason for the stock price movement.
...
Instructions:
- If prices are increasing, explain the positive reasons (growth, demand, strong performance).
- If prices are decreasing, explain the negative reasons (market correction, profit booking, weak sentiment).
- Mention specific stocks influencing the movement.
- Keep the explanation simple, realistic, and human-friendly.
- Maximum 2 lines.`;
